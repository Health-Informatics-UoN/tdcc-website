...
{return(e.which==1||e.which==13||e.which==32||e.which==undefined)?true:false;}};})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5e7f48a0d577d',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',expandOnTab:false,});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5e7f4cff713a4',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',expandOnTab:false,});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5e7f46a24810a',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',expandOnTab:false,});});})(jQuery);